...
class RegisterValidation {
    inject() {
        return [(0, express_validator_1.body)('email', 'Enter your e-mail').exists().isEmail().withMessage('Check your e-mail').bail(),
            (0, express_validator_1.body)('email').custom((value) => this.emailCheck(value)),
            ...
            (0, express_validator_1.body)('password1').custom((value, req) => this.passwordCheck(value, req))];
    }
