...
const API_2 = require("./Routes/API");
...
app.route(new API_1.AuthRoute());
app.route(new API_1.FileRoute());
app.route(new API_1.CategoryRoute());
app.route(new API_1.ProductRoute());
app.route(new API_2.UserRoute());
app.route(new API_1.OrderRoute());
